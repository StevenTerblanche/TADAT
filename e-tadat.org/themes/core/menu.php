					...
					<div class="sidebar-scrollarea">
							<div class="side-nav">
									<ul class="nav" style="background-color:#125b8c !important;">
											<li><a class="pl12 <?php echo (uri_string() == 'dashboard' || uri_string() == '') ? '' : ''; ?>" href="<?php echo base_url('/dashboard'); ?>"><i class="fa fa-dashboard"></i><span class="txt"><?php echo lang('dashboard'); ?></span></a></li>
											<?php
