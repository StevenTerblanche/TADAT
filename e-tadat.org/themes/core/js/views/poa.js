$(document).ready(function() {
   ...
   tinymce.init({
	...
	$('#back_button').click(function(){var url = 'https://e-tadat.org/poa/list'; $(location).attr('href',url); return false;});	
});