$(document).ready(function() {
	...
	// Function to work around the JavaScript toFixed(2) problem in different browser implementations by using numbers represented in exponential notation.
	...
	function calculateTotalTaxRevenueCollectionsColumnA(){
		...
		var percentage_tax_1_a = +tax_1_a/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_2_a = +tax_2_a/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_3_a = +tax_3_a/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_4_a = +tax_4_a/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_5_a = +tax_5_a/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_6_a = +tax_6_a/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_7_a = +tax_7_a/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_8_a = +tax_8_a/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_9_a = +tax_9_a/calculated_total_tax_revenue_collections * 100;
		// Calculate the total percentage of the different Taxes
		var calculated_total_tax_revenue_collections_percent = percentage_tax_1_a + percentage_tax_2_a + percentage_tax_3_a + percentage_tax_4_a + percentage_tax_5_a + percentage_tax_6_a + percentage_tax_7_a + percentage_tax_8_a + percentage_tax_9_a;
		...
		var percentage_gdp_1_a = +tax_1_a/field_value_of_gdp * 100;
		var percentage_gdp_2_a = +tax_2_a/field_value_of_gdp * 100;
		var percentage_gdp_3_a = +tax_3_a/field_value_of_gdp * 100;
		var percentage_gdp_4_a = +tax_4_a/field_value_of_gdp * 100;
		var percentage_gdp_5_a = +tax_5_a/field_value_of_gdp * 100;
		var percentage_gdp_6_a = +tax_6_a/field_value_of_gdp * 100;
		var percentage_gdp_7_a = +tax_7_a/field_value_of_gdp * 100;
		var percentage_gdp_8_a = +tax_8_a/field_value_of_gdp * 100;
		var percentage_gdp_9_a = +tax_9_a/field_value_of_gdp * 100;

		// Calculate the total percentage of the different Taxes
		var calculated_total_gdp_percent = percentage_gdp_1_a + percentage_gdp_2_a + percentage_gdp_3_a + percentage_gdp_4_a + percentage_gdp_5_a + percentage_gdp_6_a + percentage_gdp_7_a + percentage_gdp_8_a + percentage_gdp_9_a;
	...
	function calculateTotalTaxRevenueCollectionsColumnB(){
		...
		// Set the variables and values for the different Taxes (percentages)
		var percentage_tax_1_b = +tax_1_b/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_2_b = +tax_2_b/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_3_b = +tax_3_b/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_4_b = +tax_4_b/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_5_b = +tax_5_b/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_6_b = +tax_6_b/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_7_b = +tax_7_b/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_8_b = +tax_8_b/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_9_b = +tax_9_b/calculated_total_tax_revenue_collections * 100;

		// Calculate the total percentage of the different Taxes
		var calculated_total_tax_revenue_collections_percent = percentage_tax_1_b + percentage_tax_2_b + percentage_tax_3_b + percentage_tax_4_b + percentage_tax_5_b + percentage_tax_6_b + percentage_tax_7_b + percentage_tax_8_b + percentage_tax_9_b;
		...
		// Set the variables for the different Taxes (percentages) In Percent of GDP
		var percentage_gdp_1_b = +tax_1_b/field_value_of_gdp * 100;
		var percentage_gdp_2_b = +tax_2_b/field_value_of_gdp * 100;
		var percentage_gdp_3_b = +tax_3_b/field_value_of_gdp * 100;
		var percentage_gdp_4_b = +tax_4_b/field_value_of_gdp * 100;
		var percentage_gdp_5_b = +tax_5_b/field_value_of_gdp * 100;
		var percentage_gdp_6_b = +tax_6_b/field_value_of_gdp * 100;
		var percentage_gdp_7_b = +tax_7_b/field_value_of_gdp * 100;
		var percentage_gdp_8_b = +tax_8_b/field_value_of_gdp * 100;
		var percentage_gdp_9_b = +tax_9_b/field_value_of_gdp * 100;

		// Calculate the total percentage of the different Taxes
		var calculated_total_gdp_percent = percentage_gdp_1_b + percentage_gdp_2_b + percentage_gdp_3_b + percentage_gdp_4_b + percentage_gdp_5_b + percentage_gdp_6_b + percentage_gdp_7_b + percentage_gdp_8_b + percentage_gdp_9_b;
	...
	function calculateTotalTaxRevenueCollectionsColumnC(){
		...
		// Set the variables and values for the different Taxes (percentages)
		var percentage_tax_1_c = +tax_1_c/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_2_c = +tax_2_c/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_3_c = +tax_3_c/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_4_c = +tax_4_c/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_5_c = +tax_5_c/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_6_c = +tax_6_c/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_7_c = +tax_7_c/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_8_c = +tax_8_c/calculated_total_tax_revenue_collections * 100;
		var percentage_tax_9_c = +tax_9_c/calculated_total_tax_revenue_collections * 100;

		// Calculate the total percentage of the different Taxes
		var calculated_total_tax_revenue_collections_percent = percentage_tax_1_c + percentage_tax_2_c + percentage_tax_3_c + percentage_tax_4_c + percentage_tax_5_c + percentage_tax_6_c + percentage_tax_7_c + percentage_tax_8_c + percentage_tax_9_c;
		...
		// Set the variables for the different Taxes (percentages) In Percent of GDP
		var percentage_gdp_1_c = +tax_1_c/field_value_of_gdp * 100;
		var percentage_gdp_2_c = +tax_2_c/field_value_of_gdp * 100;
		var percentage_gdp_3_c = +tax_3_c/field_value_of_gdp * 100;
		var percentage_gdp_4_c = +tax_4_c/field_value_of_gdp * 100;
		var percentage_gdp_5_c = +tax_5_c/field_value_of_gdp * 100;
		var percentage_gdp_6_c = +tax_6_c/field_value_of_gdp * 100;
		var percentage_gdp_7_c = +tax_7_c/field_value_of_gdp * 100;
		var percentage_gdp_8_c = +tax_8_c/field_value_of_gdp * 100;
		var percentage_gdp_9_c = +tax_9_c/field_value_of_gdp * 100;

		// Calculate the total percentage of the different Taxes
		var calculated_total_gdp_percent = percentage_gdp_1_c + percentage_gdp_2_c + percentage_gdp_3_c + percentage_gdp_4_c + percentage_gdp_5_c + percentage_gdp_6_c + percentage_gdp_7_c + percentage_gdp_8_c + percentage_gdp_9_c;
...
console.log(round(calculated_total_gdp_percent, 1));
		// Set the field value of total_gdp_percent
