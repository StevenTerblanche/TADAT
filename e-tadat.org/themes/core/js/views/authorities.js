$(document).ready(function() {
	...
	function set_state(id, table, ignore){
		...
		$.ajax({
			async:false, data:data,	url:'https://e-tadat.org/ajax/populateStateForm/',
	...
	$('#responsive-datatables').dataTable({
		"sDom": "<'row'<'col-md-12 col-xs-12 no-margin'f>r>t<'row'<'col-md-4 col-xs-4 no-margin'l><'col-md-4 col-xs-4 no-margin center'i><'col-md-4 col-xs-4 no-margin'p>r>","pageLength": 20,
		...
		$('#back_button').click(function(){var url = 'https://e-tadat.org/authorities/list'; $(location).attr('href',url); return false;});	
