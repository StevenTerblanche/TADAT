		...
		<?php if ($get_record_by_id_users){?>
			<div class="row profile">
				<div class="col-md-12">
					<div class="profile-name">
						<h3 class="mb10"><?php echo _get_fields_by_id('Titles', 'id' ,$get_record_by_id_users->fkidTitle, array('title')).' ' . $get_record_by_id_users->name . ' ' . $get_record_by_id_users->surname; ?></h3>
					</div>
				</div>
			</div>
			<div class="col-md-12 pl0 pr0 ml0 mr0 bt">
				<div class="col-md-4 pl0 pr0 text-muted">
					...
					<div class="col-md-12 pl0 pr0 text-muted"><?php echo lang('position') , ': ' , ($get_record_by_id_users->fkidUserRole) ? _get_fields_by_id('UserRoles', 'id' ,$get_record_by_id_users->fkidUserRole, array('role')) : lang('none_specified');?></div>
					...
					<div class="col-md-12 pl0 pr0 text-muted"><?php echo lang('language'), ': ' , ($get_record_by_id_users->fkidLanguage) ? _get_fields_by_id('Languages', 'id' ,$get_record_by_id_users->fkidLanguage, array('language')) : lang('none_specified');?></div>
				...
				<div class="col-md-4 pl0 pr0 text-muted">
					...
					<div class="col-md-12 pl0 pr0 text-muted"><?php echo lang('city') ,': ', ($get_record_by_id_users->city) ? $get_record_by_id_users->city .' '. _get_fields_by_id('Countries', 'id' ,$get_record_by_id_users->fkidCountry, array('(country)')) : lang('none_specified');?></div>
				</div>
				<div class="col-md-4 pl0 pr0 text-muted">
					...
					<div class="col-md-12 pl0 pr0 text-muted"><?php echo lang('registered'),lang('_by') , ': ' , ($get_record_by_id_users->fkidUserCreated) ? _get_fields_by_id('Users', 'id' ,$get_record_by_id_users->fkidUserCreated, array('name', 'surname'), ' ') : lang('none_specified');?></div>
				</div>
			</div>
			...
			<div class="col-md-12 pl0 pr0">
				<div class="social bt">
					<h5 class="text-muted bld pb5">Connect via Social Media with <?php echo _get_fields_by_id('Titles', 'id' ,$get_record_by_id_users->fkidTitle, array('title')). ' ' . $get_record_by_id_users->name . ' ' . $get_record_by_id_users->surname;?></h5>
