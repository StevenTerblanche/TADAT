...
<?php echo form_open($uri, array('role'=>'form', 'class'=>'form-horizontal', 'id'=>'form-submit')); ?>
	<table class="table table-striped pmq-table" style="width:98% !important">
		...
		<tr>
			<td>9.1.1 Company Income Tax</td>
		...
		<tr>
			<td>9.1.2 Personal Income Tax</td>
		...
		<tr>
			<td>9.1.4 Pay as you Earn withholding (declarations filed by employers)</td>
		...
		<tr>
			<td>9.2.1 Company Income Tax</td>
		...
		<tr>
			<td>9.2.2 Personal Income Tax</td>
		...
		<tr>
			<td>9.2.4 Pay as you Earn withholding (remitted by employers)</td>
		...
		<tr>
			<td>9.3.1 Company Income Tax</td>
		...
		<tr>
			<td>9.3.2 Personal Income Tax</td>
		...
		<tr>
			<td>9.3.4 Pay as you Earn withholding (remitted by employers)</td>
		...
		<tr><td colspan="4">
			...
			<p><sup>1</sup>Data in this table will provide an indicator of the extent to which the tax administration is using modern technology to transform operations, namely in areas of filing and payment.</p>
			<p><sup>2</sup>For purposes of this table, electronic filing involves facilities that enable taxpayers to complete tax declarations online and file those declarations via the Internet.</p>
			<p><sup>3</sup>Methods of electronic payment include credit cards, debit cards, and electronic funds transfer (where money is electronically transferred via the Internet from a taxpayer's bank account to the Treasury account). Electronic payments may be made, for example, by mobile telephone where technology is used to turn mobile phones into an Internet terminal from which payments can be made. For TADAT measurement purposes, payments made in-person by a taxpayer to a third party agent (e.g., a bank or post office) that are then electronically transferred by the agent to the Treasury account are accepted as electronic payments.</p>
		</td></tr>
