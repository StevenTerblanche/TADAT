				...
				<table class="table table-bordered table-striped dt-responsive non-responsive mb10" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<tr class="va" id="div_id_dimension_<?php echo $cnt; ?>_reason_uploaded">
							<td class="va" colspan="4">
								<div id="uploader_<?php echo $cnt; ?>" data-url="https://e-tadat.org/ajax/populateUploadedForm/?upload_type=1&missionId=<?php echo $this->session->userdata('mission_id').'&indicatorId='.$this->session->userdata('indicator_id').'&dimensionId='.$cnt; ?>"></div>
