						...
						<?php start_accordion_panel($strFieldsetStatus, $dimension_5_12_1_2_a, 'dimension_5_12_1_2_a', 'b', 'b2', '5.12.1.2 The extent electronic payment arrangements are available and used for:');?>
							<div class="answer-wrapper">
									<p style="padding-top:12px !important; font-weight:bold !important">5.12.1.2 a) The Tax Administration indicated that the electronic payment arrangements available and used for CIT during the combined periods of <?php echo $periods;?> is  
										<?php 
										$dimension_5_12_1_2_a_percentage_1 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'cit_electronic_payments_value_1', '');
										$dimension_5_12_1_2_a_percentage_2 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'cit_electronic_payments_value_2', '');
										$dimension_5_12_1_2_a_percentage_3 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'cit_electronic_payments_value_3', '');																				
							...
							<div class="answer-wrapper">
									<p style="padding-top:12px !important; font-weight:bold !important">5.12.1.2 b) The Tax Administration indicated that the electronic payment arrangements available and used for PIT during the combined periods of <?php echo $periods;?> is  
										<?php 
										$dimension_5_12_1_2_b_percentage_1 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'pit_electronic_payments_value_1', '');
										$dimension_5_12_1_2_b_percentage_2 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'pit_electronic_payments_value_2', '');
										$dimension_5_12_1_2_b_percentage_3 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'pit_electronic_payments_value_3', '');																				
							...
							<div class="answer-wrapper">
									<p style="padding-top:12px !important; font-weight:bold !important">5.12.1.2 c) The Tax Administration indicated that the electronic payment arrangements available and used for VAT during the combined periods of <?php echo $periods;?> is  
										<?php 
										$dimension_5_12_1_2_c_percentage_1 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'vat_electronic_payments_value_1', '');
										$dimension_5_12_1_2_c_percentage_2 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'vat_electronic_payments_value_2', '');
										$dimension_5_12_1_2_c_percentage_3 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'vat_electronic_payments_value_3', '');																				
							...
							<div class="answer-wrapper">
									<p style="padding-top:12px !important; font-weight:bold !important">5.12.1.2 d) The Tax Administration indicated that the electronic payment arrangements available and used for PAYE witholding during the combined periods of <?php echo $periods;?> is  
										<?php 
										$dimension_5_12_1_2_d_percentage_1 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'paye_electronic_payments_value_1', '');
										$dimension_5_12_1_2_d_percentage_2 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'paye_electronic_payments_value_2', '');
										$dimension_5_12_1_2_d_percentage_3 = _get_field_by_id_single_row('db_b', 'pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'paye_electronic_payments_value_3', '');																				
