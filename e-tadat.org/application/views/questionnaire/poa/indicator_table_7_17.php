						...
						<?php start_accordion_panel($strFieldsetStatus, $dimension_7_17_1_1, 'dimension_7_17_1_1', 'a', 'a1', '7.17.1.1 The value of tax in dispute at fiscal year-end in percent of total tax revenue collections for the fiscal year');?>
							<div class="answer-wrapper">						
								<?php
									...
									$tax_dispute_1 = _get_field_by_id_single_row('db_b','pmq_table_8', 'fkidMission', $this->session->userdata('mission_id'), 'dispute_total_1', $numRecords = null);
									$tax_dispute_2 = _get_field_by_id_single_row('db_b','pmq_table_8', 'fkidMission', $this->session->userdata('mission_id'), 'dispute_total_2', $numRecords = null);
									$tax_dispute_3 = _get_field_by_id_single_row('db_b','pmq_table_8', 'fkidMission', $this->session->userdata('mission_id'), 'dispute_total_3', $numRecords = null);
					...
					<div class="panel-group accordion" id="accordion-b">
						...
						<?php start_accordion_panel($strFieldsetStatus, $dimension_7_17_2_1, 'dimension_7_17_2_1', 'b', 'b1', '7.17.2.1 The number of objections and judicial appeal cases at fiscal year-end relative to the number of cases at the start of the year');?>
								<?php
									...
									$period_0 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'period_year_0', $numRecords = null);
									$period_1 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'period_year_1', $numRecords = null);
									$period_2 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'period_year_2', $numRecords = null);
									$period_3 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'period_year_3', $numRecords = null);
									
									$objections_tomu_0 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'objections_tomu_0', $numRecords = null);
									$objections_tomu_1 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'objections_tomu_1', $numRecords = null);
									$objections_tomu_2 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'objections_tomu_2', $numRecords = null);
									$objections_tomu_3 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'objections_tomu_3', $numRecords = null);									
									...
									$objections_audit_0 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'objections_audit_0', $numRecords = null);
									$objections_audit_1 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'objections_audit_1', $numRecords = null);
									$objections_audit_2 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'objections_audit_2', $numRecords = null);
									$objections_audit_3 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'objections_audit_3', $numRecords = null);									
									...
									$judicial_appeals_0 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'judicial_appeals_0', $numRecords = null);
									$judicial_appeals_1 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'judicial_appeals_1', $numRecords = null);
									$judicial_appeals_2 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'judicial_appeals_2', $numRecords = null);
									$judicial_appeals_3 = _get_field_by_id_single_row('db_b','pmq_table_9', 'fkidMission', $this->session->userdata('mission_id'), 'judicial_appeals_3', $numRecords = null);									
