<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	$arrTrc = _get_fields_by_id_array('db_b', 'pmq_table_1', 'fkidMission', $mission_id, $out = array('a_total_revenue_collections','b_total_revenue_collections','c_total_revenue_collections'));
