				...
				foreach ($get_record_all_rev_auth as $key => $value){
					...
					echo "<tr class='va'>";
						...
						if($value['fkidCounterpart'] != 0){
							echo "<td class='va'>"._get_fields_by_id('Users', 'id' ,$value['fkidCounterpart'], array('title', 'name', 'surname'), ' ')."</td>";
						}else{
							echo "<td class='va'>"._get_fields_by_id('Users', 'id' ,$value['fkidUser'], array('title', 'name', 'surname'), ' ')."</td>";
						}
