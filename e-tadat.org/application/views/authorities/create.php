				...
				<div class="form-group">
					...
					<div class="col-xs-6">
						<div class="input-group">
							...
							<?php echo form_dropdown("fkidRegion", $get_dropdown_all_region, set_value("fkidRegion",$fkidRegion), array('id'=>'region', 'class'=>'form-control', 'required'=>'')); ?>
						</div>
					</div>
				</div>	
				...
				<div class="form-group">
					...
					<div class="col-xs-6">
						<div class="input-group">
							...
							<?php echo form_input(array('name'=>'code', 'value'=>$code, 'class'=>'form-control', 'placeholder'=>lang('postal').lang('_code'))); ?>
						</div>
					</div>
				</div>
				<div class="form-group">
