		...
		<?php if ($get_record_by_id_rev_auth){?>
			...
			<div class="col-md-12 pl0 pr0 ml0 mr0 bt">
				...
				<div class="col-md-4 pl0 pr0 text-muted">
					...
					<div class="col-md-12 pl0 pr0 text-muted"><?php echo lang('created'),lang('_by') , ': ' , (_get_fields_by_id('Titles', 'id' ,$get_record_by_id_rev_auth->fkidTitle, array('title')) || $get_record_by_id_rev_auth->name ||$get_record_by_id_rev_auth->surname) ? _get_fields_by_id('Titles', 'id' ,$get_record_by_id_rev_auth->fkidTitle, array('title')) .  ' ' . $get_record_by_id_rev_auth->name . ' ' .$get_record_by_id_rev_auth->surname : lang('none_specified');?></div>
