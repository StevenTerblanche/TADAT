			...
			<div class="panel-body pt0 pl5 pr5 pb10">
				<div class="progressbar-stats-1">
					...
					<div class="comparison">
						<p class="mb0 mt10"><i class="fa fa-arrow-circle-o-right s20 mr5 pull-left"></i><a class="white-text fs12 lh20" href="<?php echo base_url().'missions/list';?>"><?php echo lang('click_').lang('here').lang('_to_').strtolower(lang('view_')).lang('missions'); ?></a></p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="panel dashboard-red-panel tile panelClose toggle">
			...
			<div class="panel-body pt0 pl5 pr5 pb10">
				<div class="progressbar-stats-1">
					...
					<div class="comparison">
						<p class="mb0"><i class="fa fa-arrow-circle-o-right s20 mr0 pull-left"></i><a class="white-text fs12 lh20" href="<?php echo base_url().'authorities/list';?>"><?php echo lang('click_').lang('here').lang('_to_').strtolower(lang('view_')).lang('revenue_authorities'); ?></a></p>
					</div>
				</div>
			</div>
		</div>
