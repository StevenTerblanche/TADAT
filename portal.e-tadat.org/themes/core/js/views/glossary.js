$(document).ready(function() {
 tinymce.init({
	...
	$('#responsive-datatables').dataTable({
		...
		"lengthMenu": [ [10, 20, 50, -1], [10, 20, 50, "All"] ],"bSort": false, "fnDrawCallback": function(oSettings) {
			...
			if(oSettings.fnRecordsTotal() < 5){$('.dataTables_length').hide(); $('.dataTables_paginate').hide();
