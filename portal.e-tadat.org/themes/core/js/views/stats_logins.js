$(document).ready(function() {
	...
	$('#responsive-datatables').dataTable({
		...
		"lengthMenu": [ [10, 20, 50, -1], [10, 20, 50, "All"] ],"order": [[ 0, 'desc' ]], "columnDefs": [{ orderable: true, targets: [3] }], "fnDrawCallback": function(oSettings) {
	...
	$('#back_button').click(function(){var url = 'http://e-tadat.org/users/list'; $(location).attr('href',url); return false;});	
});