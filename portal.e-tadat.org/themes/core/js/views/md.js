$(document).ready(function() {
	...
	$('#responsive-datatables').dataTable({
		"sDom": "<'row'<'col-md-12 col-xs-12 no-margin'f>r>t<'row'<'col-md-4 col-xs-4 no-margin'l><'col-md-4 col-xs-4 no-margin center'i><'col-md-4 col-xs-4 no-margin'p>r>","pageLength": 100,
		...
		"fnDrawCallback": function(oSettings){
			...
			if(oSettings.fnRecordsTotal() < 110){
	...
	$('#back_button').click(function(){var url = 'http://e-tadat.org/pi/list'; $(location).attr('href',url); return false;});	
});