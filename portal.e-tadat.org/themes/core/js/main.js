...
$('#back_to_applicant_listing').click(function(){var url = 'https://portal.e-tadat.org/secretariat/dashboard'; $(location).attr('href',url); return false;});				
$('#back_to_approved_listing').click(function(){var url = 'https://portal.e-tadat.org/users/approved'; $(location).attr('href',url); return false;});				
...
$(document).ready(function() {
	...
	window.setTimeout(function() {
		$(".alert_panel_closer_error").fadeTo(500, 0).slideUp(500, function(){
			$(this).remove(); 
		});
	}, 6000);
	
	window.setTimeout(function() {
		$(".alert_panel_closer").fadeTo(500, 0).slideUp(500, function(){
			$(this).remove(); 
		});
	}, 3000);
    ...
    $('body').dynamic({
        ...
        panels: {
            refreshIcon: 'fa fa-circle-o gray-text',//refresh icon for panels
            toggleIcon: 'fa fa-angle-up gray-text',//toggle icon for panels
            collapseIcon: 'fa fa-angle-down gray-text',//colapse icon for panels
            closeIcon: 'fa fa-times gray-text', //close icon
