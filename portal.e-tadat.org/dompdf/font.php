...
//Edited by Ejaz
$_SERVER["argv"][1] = "shelley";
$_SERVER["argv"][2] = "./shelley.ttf";
$_SERVER["argc"] = 3;
$fontname = $_POST['name'];
$normal = $_POST['normal'];
$bold = $_POST['bold'];
$italic = $_POST['italic'];
$bold_italic = $_POST['bold_italic'];
//Edited by Ejaz
...
if ( $_SERVER["argv"][1] === "system_fonts" ) {
  ...
  foreach ( $fonts as $family => $files ) {
    ...
    install_font_family($fontname, $normal, $bold, $italic, $bold_italic);
...
THE CODE IS GENERATED BY <b>EJAZ ANSARI<b></br>
THIS FILE IS WEB BASED COMPONENT OF <b>'load_font.php'</b></br>
NOTE : REMOVE THIS FILE FROM YOUR SERVER AFTER INSTALLING THE FONTS</br>
 
Download this file***********</br> 
* THIS FILE AND FONT FILE SHOUD BE IN ROOT DIRECTORY OF DOMPDF ,AT SAME LEVLE WHERE 'load_font.php' IS LOCATED
</br>
 
<hr>
<form action="" method="post">
<B>ALL * FIELDS ARE COMPULSORY, OTHERS ARE OPTIONAL</B></br></br>
    <table><tr><td>FONT NAME:</td><td><input type="text" name="name"/>to be use in css ex.(font-family:Arial) etc</td></tr>
    <tr><td>FONT FILE NAME:</td><td><input type="text" name="normal"/>with extension ex. (.ttf) etc</td></tr>
    <tr><td>BOLD FONT FILE NAME :</td><td><input type="text" name="bold"/>with extension ex. (.ttf) etc</td></tr>
    <tr><td>ITALIC FONT FILE NAME:</td><td><input type="text" name="italic"/>with extension ex. (.ttf) etc</td></tr>
    <tr><td>BOLD-ITALIC FONT FILE NAME:</td><td><input type="text" name="bold_italic"/>with extension ex. (.ttf) etc</td></tr>
    <tr><td></td><td>
    <input type="reset" value="Reset"/><input type="submit" value="Upload" name="submit"/></td></tr>
    </table>
</form>