					...
					<div class="panel-group accordion" id="accordion-a">
						...
						<?php start_accordion_panel($strFieldsetStatus, $dimension_7_18_1_1, 'dimension_7_18_1_1', 'a', 'a1', '7.18.1.1 Does the tax administration routinely monitor the time taken to determine objections?');?>
								<?php
									...
									//$process_refunds = _get_field_by_id_single_row('cloud_questions','pmq_table_10', 'fkidMission', $this->session->userdata('mission_id'), 'process_refunds', $numRecords = null);
									//$process_returns = _get_field_by_id_single_row('cloud_questions','pmq_table_10', 'fkidMission', $this->session->userdata('mission_id'), 'process_returns', $numRecords = null);
									$process_objections = _get_field_by_id_single_row('cloud_questions','pmq_table_10', 'fkidMission', $this->session->userdata('mission_id'), 'process_objections', $numRecords = null);
									//$process_correspond = _get_field_by_id_single_row('cloud_questions','pmq_table_10', 'fkidMission', $this->session->userdata('mission_id'), 'process_correspond', $numRecords = null);									
