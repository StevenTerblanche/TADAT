...
<!--START ACCORDION -->
					<?php start_accordion_panel($strFieldsetStatus, $dimension_8_21_3_3, 'dimension_8_21_3_3', 'c', 'c3', '8.21.3.3 The extent that core taxes use electronic filing.');?>
								<?php
									$period_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'period_year_1', $numRecords = null);
									$period_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'period_year_2', $numRecords = null);
									$period_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'period_year_3', $numRecords = null);
									
									$cit_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'cit_electronic_filing_percent_1', $numRecords = null);
									$cit_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'cit_electronic_filing_percent_2', $numRecords = null);
									$cit_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'cit_electronic_filing_percent_3', $numRecords = null);
									$cit_total = $cit_1 + $cit_2 + $cit_3;

									$pit_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'pit_electronic_filing_percent_1', $numRecords = null);
									$pit_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'pit_electronic_filing_percent_2', $numRecords = null);
									$pit_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'pit_electronic_filing_percent_3', $numRecords = null);
									$pit_total = $pit_1 + $pit_2 + $pit_3;

									$vat_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'vat_electronic_filing_percent_1', $numRecords = null);
									$vat_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'vat_electronic_filing_percent_2', $numRecords = null);
									$vat_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'vat_electronic_filing_percent_3', $numRecords = null);
									$vat_total = $vat_1 + $vat_2 + $vat_3;

									$paye_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'paye_electronic_filing_percent_1', $numRecords = null);
									$paye_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'paye_electronic_filing_percent_2', $numRecords = null);
									$paye_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'paye_electronic_filing_percent_3', $numRecords = null);
		...
		<div class="tab-pane fade text-muted" id="dimension_d">
				...
				<p><strong><?php $numCounter = 3; if(isset($measurement_dimensions[$numCounter]['dimensionName'])){echo '8.21.4 '. $measurement_dimensions[$numCounter]['dimensionName'];}?></strong></p>
					...
					<?php
						...
						$cit_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'cit_electronic_payments_value_1', $numRecords = null);
						$cit_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'cit_electronic_payments_value_2', $numRecords = null);
						$cit_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'cit_electronic_payments_value_3', $numRecords = null);
						$cit_total = $cit_1 + $cit_2 + $cit_3;

						$pit_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'pit_electronic_payments_value_1', $numRecords = null);
						$pit_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'pit_electronic_payments_value_2', $numRecords = null);
						$pit_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'pit_electronic_payments_value_3', $numRecords = null);
						$pit_total = $pit_1 + $pit_2 + $pit_3;

						$vat_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'vat_electronic_payments_value_1', $numRecords = null);
						$vat_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'vat_electronic_payments_value_2', $numRecords = null);
						$vat_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'vat_electronic_payments_value_3', $numRecords = null);
						$vat_total = $vat_1 + $vat_2 + $vat_3;

						$paye_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'paye_electronic_payments_value_1', $numRecords = null);
						$paye_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'paye_electronic_payments_value_2', $numRecords = null);
						$paye_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_11', 'fkidMission', $this->session->userdata('mission_id'), 'paye_electronic_payments_value_3', $numRecords = null);
						$paye_total = $paye_1 + $paye_2 + $paye_3;
