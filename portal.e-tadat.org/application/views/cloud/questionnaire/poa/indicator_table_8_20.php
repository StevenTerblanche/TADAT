					...
					<div class="panel-group accordion" id="accordion-a">
						...
						<?php start_accordion_panel($strFieldsetStatus, $dimension_8_20_1_1, 'dimension_8_20_1_1', 'a', 'a1', '8.20.1.1 What is the ratio of tax revenue collections to budgeted tax revenues for each of the past three fiscal years?');?>
								<?php
									...
									$tax_budgeted_1 = _get_field_by_id_single_row('cloud_questions','pmq_table_1', 'fkidMission', $this->session->userdata('mission_id'), 'a_budgeted_revenue', $numRecords = null);
									$tax_budgeted_2 = _get_field_by_id_single_row('cloud_questions','pmq_table_1', 'fkidMission', $this->session->userdata('mission_id'), 'b_budgeted_revenue', $numRecords = null);
									$tax_budgeted_3 = _get_field_by_id_single_row('cloud_questions','pmq_table_1', 'fkidMission', $this->session->userdata('mission_id'), 'c_budgeted_revenue', $numRecords = null);
