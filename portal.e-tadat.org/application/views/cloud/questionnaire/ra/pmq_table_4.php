...
<?php echo form_open($uri, array('role'=>'form', 'class'=>'form-horizontal', 'id'=>'form-submit')); ?>
	<table class="table table-striped pmq-table" style="width:98% !important">
		<tr class="dark-blue">
			...
			<td class="center bld wp-25"><p>Number of declarations filed on-time<sup>1</sup></p></td>
			<td class="center bld wp-25"><p>Number of declarations expected to be filed<sup>2</sup></p></td>
			<td class="center bld wp-25"><p>On-time filing rate<sup>3</sup> (In percent)</p></td>
		</tr>
		<tr>
			<td><b>4.1.1 All CIT taxpayers</b></td>
			<td class="center"><?php echo form_input(array('name'=>'filing_cit_paid_all', 'id'=>'id_filing_cit_paid_all', 'value'=>$filing_cit_paid_all, 'class'=>'form-control pmq-number-input center', 'required'=>''));?></td>
			<td class="center"><?php echo form_input(array('name'=>'filing_cit_due_all', 'id'=>'id_filing_cit_due_all', 'value'=>$filing_cit_due_all, 'class'=>'form-control pmq-number-input center', 'required'=>''));?></td>
			<td class="center"><?php echo form_input(array('name'=>'filing_cit_percentage_all', 'id'=>'id_filing_cit_percentage_all', 'value'=>$filing_cit_percentage_all, 'class'=>'form-control pmq-percentage-input center', 'readonly'=>'readonly'));?></td>
		</tr>
		<tr>
			<td><b>4.1.2 Large taxpayers only</b></td>
			<td class="center"><?php echo form_input(array('name'=>'filing_cit_paid_large', 'id'=>'id_filing_cit_paid_large', 'value'=>$filing_cit_paid_large, 'class'=>'form-control pmq-number-input center', 'required'=>''));?></td>
			<td class="center"><?php echo form_input(array('name'=>'filing_cit_due_large', 'id'=>'id_filing_cit_due_large', 'value'=>$filing_cit_due_large, 'class'=>'form-control pmq-number-input center', 'required'=>''));?></td>
			<td class="center"><?php echo form_input(array('name'=>'filing_cit_percentage_large', 'id'=>'id_filing_cit_percentage_large', 'value'=>$filing_cit_percentage_large, 'class'=>'form-control pmq-percentage-input center', 'readonly'=>'readonly'));?></td>
		<tr>
			<td colspan="4">
