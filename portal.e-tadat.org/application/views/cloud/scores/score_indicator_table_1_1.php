...
/*
	...
	$fieldsDimension_1 = array('dimension_1_1_1',
						 		...
						 		'dimension_1_1_6',
						 		'dimension_1_1_7');
	$resultDimension_1 = array('Table'=>$get_record_table[0]['questionTable'],	_get_record_by_id_score_table($this->session->userdata('mission_id'), 'cloud_questions', $get_record_table[0]['questionTable'], $fieldsDimension_1));
	$scoreDimension_1 = 4;	
	...
	$methodDimension_1 = _get_record_by_id_score_method($arrDimensions[0]['id'], $scoreDimension_1, 'cloud_questions', 'MeasurementDimensionsScoring', $fields = array('criteria'));
*/	
