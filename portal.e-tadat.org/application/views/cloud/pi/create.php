<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
	...
	if($this->action === 'update'){
		...
		if(!isset($footnote)) $footnote = ''; 
				...
				<div class="form-group">
					...
					<div class="col-xs-7">
						<div class="input-group">
							...
							<?php echo form_dropdown("fkidPoa", $get_dropdown_all_poa, set_value("fkidPoa",$fkidPoa), array('id'=>'role', 'required'=>'', 'class'=>'form-control')); ?>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-xs-7">
						<div class="input-group">
							...
							<?php echo form_input(array('name'=>'indicatorName', 'value'=>$indicatorName, 'class'=>'form-control', 'required'=>'', 'placeholder'=>lang('performance_indicator')));?>
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-xs-3 control-label"><?php echo lang('scoring_method');?></label>
					<div class="col-xs-7">
						<div class="input-group">
							<span class="input-group-addon"><span class="fa fa-globe"></span></span>
							<?php echo form_dropdown("fkidScoringMethod", $_get_dropdown_all_sms, set_value("fkidScoringMethod",$fkidScoringMethod), array('id'=>'role', 'required'=>'', 'class'=>'form-control')); ?>
						</div>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-xs-3 control-label"><?php echo lang('footnote');?></label>
					<div class="col-xs-7">
						<div class="panelb">
							<?php echo form_textarea(array('name'=>'footnote', 'value'=>$footnote, 'class'=>'form-control', 'id'=>'summernote'));?>
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-xs-7">
						<div class="panelb">					
							<?php echo form_textarea(array('name'=>'assessment_text', 'value'=>$assessment_text, 'class'=>'form-control', 'id'=>'summernote1'));?>
						</div>						
					</div>
				</div>								
				<div class="form-group">
