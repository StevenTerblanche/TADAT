<?php defined('BASEPATH') OR exit('No direct script access allowed'); 
			if ($get_record_all_missions){
				...
				foreach ($get_record_all_missions as $key => $value){
					...
					$strViewURI = base_url('reporting/toc/?id=') . base64_encode($this->encrypt->encode($value['id']));
						...
						echo '<td class="va center">';
							echo '<div class="btn-group mr0 mb0">';
								...
								echo '<ul class="dropdown-menu dropdown-blue-bg">';
									echo '<li><a href="' . $strViewURI . '"><i class="fa fa-globe"></i>View Draft Tadat PAR</a></li>';

/*
									echo '<li><a href="' . $strEditURI . '"><i class="fa fa-edit"></i>dd</a></li>';
										if ($value['status'] === '1'){
											echo '<li><a href="' . $strDisableURI . '"><i class="fa fa-lock"></i>dd</a></li>';
										}else{
											echo '<li><a href="' . $strEnableURI . '"><i class="fa fa-unlock"></i>dd</a></li>';
										}
										*/
