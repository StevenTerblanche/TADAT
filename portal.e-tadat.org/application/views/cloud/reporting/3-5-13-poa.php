...
<div class="par-full-width-div"><p>This indicator assesses the extent to which acknowledged efficient collection systems—especially withholding at source and advance payment regimes—are used. Assessed scores are shown in Table 14 followed by an explanation of reasons underlying the assessment.</p>
	<div class="par-full-width-div" style="margin-bottom:25px !important">
		<table id="table-poa">
			<tr>
				<th colspan="4">Table 14. P5-13 Assessment</th>
			</tr>
			<tr>
