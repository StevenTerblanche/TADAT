...
?>
<div class="par-heading-full-width-div"><h1>POA 9: Accountability and Transparency</h1></div>
<div class="par-heading-full-width-div"><h2>P9-27: Public perception of integrity</h2></div>
<div class="par-full-width-div"><p>This indicator examines measures taken to gauge public confidence in the tax administration. The assessed score is shown in Table 28 followed by an explanation of reasons underlying the assessment.</p>
	<div class="par-full-width-div" style="margin-bottom:25px !important">
		<table id="table-poa">
			<tr>
				<th colspan="4">Table 28. P9-27 Assessment</th>
			</tr>
			<tr>
