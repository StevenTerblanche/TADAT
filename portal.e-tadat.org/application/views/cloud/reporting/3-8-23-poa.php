...
?>
<div class="par-heading-full-width-div"><h1>POA 8: Efficient Revenue Management</h1></div>
<div class="par-heading-full-width-div"><h2>P8-23: Adequacy of the tax revenue accounting system</h2></div>
<div class="par-full-width-div"><p>This indicator examines the adequacy of the tax revenue accounting system. Assessed scores are shown in Table 24 followed by an explanation of reasons underlying the assessment.</p>
	<div class="par-full-width-div" style="margin-bottom:25px !important">
		<table id="table-poa">
			<tr>
				<th colspan="4">Table 24. P8-23 Assessment</th>
			</tr>
			<tr>
