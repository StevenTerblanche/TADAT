...
//				alert('ddd');
        ...
        plugin.breadCrumbs = function () {
            ...
            //empty curmb
            breadcrumb.empty();
            breadcrumb.append('<li>'+homeIcon+'<a href="../../../etadat/reporting/test_files/index.html">Home</a></li>');
            ...
            if (navsub.closest('li').hasClass('hasSub')) {
                ...
                breadcrumb.append('<li>'+/*icon1*/+'<a href="../../../etadat/reporting/test_files/'+link+'">'+text1+'</a></li>');
