...
?>
	...
	<div class="par-full-width-div">
		<table id="table-pmq-1">
			<tr>
				<th colspan="4">Table 4. On-time Filing of CIT Declarations for the most recently completed year</th>
			</tr>
			<tr>
			...
			<tr>
				<td>All CIT taxpayers</td>
				<td width="175" class="center white-td"><?php echo number_format($arrParData[0]['filing_cit_paid_all'],0);?></td>
				<td width="175" class="center white-td"><?php echo number_format($arrParData[0]['filing_cit_due_all'],0);?></td>
				<td width="175" class="center white-td"><?php echo number_format($arrParData[0]['filing_cit_percentage_all'],1);?>%</td>
			</tr>
			<tr>
				<td>Large taxpayers only</td>
				<td width="175" class="center white-td"><?php echo number_format($arrParData[0]['filing_cit_paid_large'],0);?></td>
				<td width="175" class="center white-td"><?php echo number_format($arrParData[0]['filing_cit_due_large'],0);?></td>
				<td width="175" class="center white-td"><?php echo number_format($arrParData[0]['filing_cit_percentage_large'],1);?>%</td>
			</tr>
...
<p><b><sup>2</sup></b>'Expected declarations' means the number of CIT declarations that the tax administration expected to receive from registered CIT taxpayers that were required by law to file declarations.</p>
