			...
			if ($get_record_all){
				...
				foreach ($get_record_all as $key => $value){
					...
					if ($cntScores == 0){
						...
						echo "<tr class='va'>";
							echo "<td colspan='3' class='va'>". _get_record_by_id_build_poa($value['fkidMd'], '','cloud_questions') . "</td>";
						echo '</tr>';
						echo "<tr class='va'>";						
					...
					echo "<tr class='va'>";
						echo "<td class='va center'><strong>" . strtoupper(_get_fields_by_id('ScoringScales', 'id' ,$value['fkidScore'], array('score'),'','cloud_questions')) . "</strong></td>";
