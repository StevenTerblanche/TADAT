				...
				//_show_array($get_record_all_workshops);
					if ($get_record_all_workshops){
						...
						foreach ($get_record_all_workshops as $key => $value){
								$strTestURI = base_url('workshops/test/?id=')  . base64_encode($this->encrypt->encode($value['id']));
									...
									echo '<td class="va center">';
										echo '<div class="btn-group mr0 mb0">';
											...
											if($this->user->fkidUserRole === '11'){
												echo '<li><a href="'.$strAddAttendeesURI.'"><i class="fa fa-edit"></i>' . 'Add Workshop Attendees</a></li>';
												echo '<li><a href="'.$strTestURI.'"><i class="fa fa-th-list"></i>Complete Test</a></li>';
											}else if($this->user->fkidUserRole === '12'){
												echo '<li><a href="'.$strTestURI.'"><i class="fa fa-th-list"></i>Complete test</a></li>';
												// echo '<li><a href="#"><i class="fa fa-edit"></i>' . lang('update_').lang('this'). ' Workshop</a></li>';																
												// echo '<li><a href="#"><i class="fa fa-lock"></i>' . lang('disable_').lang('this').' Workshop</a></li>';
											}else{
												echo '<li><a href="'.$strTestURI.'"><i class="fa fa-th-list"></i>Test this Workshop</a></li>';
											}
											echo '</ul>';
										echo '</div>';
									echo '</td>';
