				...
				<?php
					if ($this->session->flashdata('message')){
						...
						if ($this->session->flashdata('error') || validation_errors()){
							...
							echo form_input(array('name'=>'username', 'id'=>'username', 'class'=>'input-field', 'required'=>'', 'placeholder'=>lang('email_address')));
		                    ...
		                    echo form_close();
							echo '<div class="login-links"><a href="' . base_url('forgot') . '">' . lang('forgot_password_link') . '</a> | <a href="' . base_url('register') . '">Click here to Register</a></div>';
						}
				?>
				</div> 
			</div>
