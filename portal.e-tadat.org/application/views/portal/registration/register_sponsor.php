										...
										<div class="tab-content" style="margin-top:30px !important">
											<div class="tab-pane" id="tab1">
												...
												<div class="form-group" style="margin-left:40px !important; margin-right:40px !important; color:#3B3B3B; text-align:left !important">
													<p>Registration will allow access to the following TADAT platforms:</p>
													<div class="input-group checkboxes-left">
														<ul>
															<li>TADAT Connect</li>
															<li>TADAT Surveys</li>
															<li>TADAT Trained Assessor database</li>															
														</ul>
													</div>
												</div>
											</div>
											...
											<div class="tab-pane" id="tab5">
												...
												<p>Thank you for applying for access to the TADAT Portal.</p>
												<p>Registration is not an acknowledgement of acceptance into the TADAT Portal. You will be advised shortly about the status of your application and what further information may be required.</p>
