...
// echo 'Upload View: '.$fkidUserReference.'<br>';
?>

    <form class="fileupload" action="/portal/uploads/do_upload/" method="POST" enctype="multipart/form-data">
...
<select id="description" name="description[]" class="form-control" placeholder="Document Description">
	<option value="0" selected>Select a Document Type</option>
	<option value="cv">Curriculum Vitae</option>
	<option value="photo">Profile Photograph</option>
</select>
			<input type="hidden" name="fkidUserReference" class="form-control" value="<?php echo $fkidUserReference;?>">
