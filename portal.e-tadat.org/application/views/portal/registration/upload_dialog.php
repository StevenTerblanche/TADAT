<?php // echo 'Upload Dialog View: '.$passed_referenceNumber.'<br>'; ?>
                    ...
                    <div class="modal fade" id="modal-style2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-center modal-lg">
                            <div class="modal-content">
										...
										<div id="uploadContent" class="tab-content" style="height:350px !important; margin-left:0px !important; padding-left:0px !important">
											<div id="upload" class="tab-pane fade active in text-muted" style="margin:0px !important; padding:0px !important">
												<?php
													...
													$content_data['fkidUserReference'] = $passed_referenceNumber;
													echo $this->load->view('portal/registration/upload', $content_data, true);
												?>
											</div>
											<div class="tab-pane fade text-muted" id="notes">
												<ul>
													...
													<li><strong>Image Files </strong>JPG, PNG, GIF, BMP</li>
													<li><strong>Text Files </strong>TXT, CSV</li>
													<li><strong>Archive Files</strong>ZIP, RAR</li>				
													</ul>
													</li>
                                ...
                                <div class="modal-footer"><button type="button" id="upload-dialog-closer" class="btn btn-primary" data-reference="<? echo $passed_referenceNumber ?>" >Close</button></div>
                            </div>
                        </div>
                    </div>
