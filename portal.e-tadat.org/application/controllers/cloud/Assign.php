...
class Assign extends Core_Controller {
	...
	*/
	function __construct(){
		...
		$this->add_external_js(array("/themes/core/js/jquery.dataTables.js", "/themes/core/js/dataTables.tableTools.js", "/themes/core/js/dataTables.bootstrap.js", "/themes/core/js/dataTables.responsive.js","/themes/core/js/bootstrap-datepicker.js", "/themes/core/js/views/assign.js"));
...
//		$this->output->enable_profiler(TRUE);		
	...
	function read(){
		if(!$this->id){
			$this->panel_title = strtoupper(lang('performance_indicator') . lang('_listing'));
			$this->content_data['get_record_all_pis'] = _get_record_all_pis();
	...
	function modify(){
		...
		if($this->id && !$this->action){
			...
			$this->content_data['get_record_by_id'] = _get_record_by_id_pis($this->id);
		...
		if($this->action && ($this->action !=='disable' || $this->action !=='delete')){
			...
			$this->form_validation->set_rules('poa', lang('performance_indicator').lang('_name'), 'required|trim');
