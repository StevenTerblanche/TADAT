	...
	*/
	...
	function read(){
		if($this->id && !$this->action){
			...
			$this->data['content'] = $this->load->view('cloud/missions/list', $this->content_data, true);
		}
...
*/
	...
	function modify(){
		...
		$this->content_data['get_dropdown_all_rev_auth'] = ($this->user->fkidUserRole == 1) ?  _get_dropdown_all_rev_auth_user() : _get_dropdown_all_rev_auth_user($this->user->id);

		$this->content_data['get_dropdown_all_team_leaders'] = ($this->user->fkidUserRole == 1) ?  _get_dropdown_all_team_leaders() : _get_dropdown_all_team_leaders($this->user->id);
