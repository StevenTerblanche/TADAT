...
class Dashboard extends Core_Controller {
	...
	function dashboard_developer(){
		$content_data['missions_count'] = $this->get_count('Missions',null,null,'cloud_main');
//		$content_data['authorities_count'] = $this->get_count('RevenueAuthorities',null,null,'cloud_main');
//		$content_data['users_count'] = $this->get_count('Users',null,null,'cloud_main');
//		$content_data['logins_count'] = $this->get_count('UserLogins',null,null,'cloud_main');
		$this->data['content'] = $this->load->view('cloud/dashboard/dashboard', $content_data, true);
	...
	function dashboard_sec(){
		...
		$this->data['content'] = $this->load->view('cloud/dashboard/dashboard_sect', $content_data, true);
		$this->load->view($this->template, $this->data);
	}
	...
	function dashboard_mtl(){
		...
		$this->data['content'] = $this->load->view('cloud/dashboard/dashboard_mtl', $content_data, true);
		$this->load->view($this->template, $this->data);
	}
	...
	function notifications(){		
        ...
        $this->data['content'] = $this->load->view('portal/notifications/notifications', $content_data, true);
		$this->load->view($this->template, $this->data);
	}
		
	function get_count($table = null, $query_field = null, $query_id = null, $database = null){
		if(!$table) return false;
		$this->db = get_instance()->load->database($database, true);
