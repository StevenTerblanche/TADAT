...
class Md extends Core_Controller {
	...
	*/
	function __construct(){
		...
		$this->add_external_js(array("/themes/core/js/jquery.dataTables.js", "/themes/core/js/dataTables.tableTools.js", "/themes/core/js/dataTables.bootstrap.js", "/themes/core/js/dataTables.responsive.js","/themes/core/js/bootstrap-datepicker.js", "/themes/core/js/views/md.js"));
		...
		$this->tbl = 'MeasurementDimensions';
		...
		$this->columns = 12;
		$this->page_header = strtoupper(lang('manage_').lang('mds'));
		$this->panel_icon = 'fa fa-sliders';
		$this->panel_title = strtoupper(lang('md') . lang('_listing'));		
...
//		$this->output->enable_profiler(TRUE);		
	...
	function read(){
		if(!$this->id){
			$this->panel_title = strtoupper(lang('md') . lang('_listing'));
			$this->content_data['get_record_all'] = _get_record_all_md('','cloud_questions');
			$this->data['content'] = $this->load->view('md/list', $this->content_data, true);
		}
	...
	function modify(){
		...
		# This shows the 'create view' for a NEW record if no ID OR action 
			...
			$this->content_data['get_dropdown_all_pi'] = _get_dropdown_all_pis();
	        # Get all Scoring Methods
			$this->content_data['get_dropdown_all_sms'] = _get_dropdown_all_sms();
			# Get all Measurement Dimension Types
	        $this->content_data['get_dropdown_all_mdt'] = _get_dropdown_all_mdt();			
		if(!$this->id && !$this->action){
			# Tell the crud function what to do.
			$this->action = 'create';
			# Populate view variables according to type
			$this->panel_title = lang('create_').lang('md');
			$this->content_data['submit_button'] = lang('create_').lang('md');
			...
			$this->data['content'] = $this->load->view('md/create', $this->content_data, true);
		}
		...
		if($this->id && !$this->action){
			...
			$this->action = 'update';
			# Populate view variables according to type			
			$this->panel_title = lang('update_').lang('md');
			$this->content_data['submit_button'] = lang('update_').lang('md');
			...
			$this->content_data['get_record_by_id'] = _get_record_by_id_md($this->id, '', 'cloud_questions');
	        $this->content_data['get_dropdown_all_languages'] = _get_dropdown_all_languages();			
		...
		if($this->action && ($this->action !=='disable' || $this->action !=='delete')){
			...
			$this->form_validation->set_rules('dimensionName', lang('md').lang('_name'), 'required|trim');
