...
*/
	...
	function submit(){
		...
		if($this->parId){
			$this->action = 'update';
			$this->crud_model->crud($this->action, $this->tbl, $this->form_data, $this->parId, 'id', 'cloud_questions');
		}else{
			$this->action = 'create';
			$this->crud_model->crud($this->action, $this->tbl, $this->form_data, $this->id,'', 'cloud_questions');
		}
		$this->tbl = '';
